...
<style>
    ...
    .sidebar .brand h4 { color: #fff; margin-bottom: 4px; }
    .sidebar .brand small { color: #bdc3c7; }
    .sidebar a {
        color: #fff;
    ...
    .sidebar .logout-link { color: #e74c3c !important; margin-top: 30px; }
    .sidebar .logout-link:hover { background: #c0392b; color: #fff !important; }
</style>
